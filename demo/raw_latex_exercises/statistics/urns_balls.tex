...
% Again we use $P(\textrm{not } R \textrm{ or not } B) = 1 - P(R) - P(B)$ because $P(R \textrm{ and } B) = 0$. We cannot draw a red and a blue simultaneously.
% \[
% P(\textrm{not } R \textrm{ or not } B) = 1 - P( R \textrm{ or } B) = \frac{{n_0} - ({nR}+{nB})}{{n_0}} = \frac{{p1}}{{n_0}} \approx {solB}
% \]
